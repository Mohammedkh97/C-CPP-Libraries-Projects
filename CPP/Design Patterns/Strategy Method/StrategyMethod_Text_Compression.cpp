...
int main()
{
    ...
    // Switch to a different strategy at runtime
    // Make sure to delete the previous context to avoid any memory leaks
    CompressionContext newContext(new HuffmanCompression()); // Switch to HuffmanCompression strategy
    newContext.compressData("aaabbbccccc");
